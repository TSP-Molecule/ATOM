...
//            cy1.getTransforms().add(new Translate(pointX(100, 120, bondLen) , 0, 0));//+ bondLen * Math.cos(toRadians(120))
//            cy1.getTransforms().add(new Translate(cy1.getRadius()/2, cy1.getHeight()/2, 0));

            cy1.getTransforms().add(new Rotate(120, 0, 0, 0, Rotate.Z_AXIS));
            cy1.getTransforms().add(new Translate(0, 200, 0));
            // cy1.getTransforms().add(new Translate(0, 0, 100));
            // cy1.getTransforms().add(new Translate(cy1.getLayoutX() + bondLen * Math.cos(toRadians(120)), 0, 0));
            // cy1.getTransforms().add(new Translate(600, 0, 0));//  cy1.getTransforms().add(new Translate(0, 100, 100));
